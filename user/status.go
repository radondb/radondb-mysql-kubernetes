...
func (u *User) UpdateStatusCondition(condType v1alpha1.UserConditionType, status corev1.ConditionStatus,
	...
	if status != existingCondition.Status {
		...
		changed = true
		// log.V(3).Info(fmt.Sprintf("Found status change for mysql user "+
...
func (u *User) ConditionExists(ct v1alpha1.UserConditionType) (*v1alpha1.UserCondition, bool) {

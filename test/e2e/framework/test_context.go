...
func RegisterCommonFlags() {
	...
	flag.StringVar(&TestContext.ReportDir, "report-dir", "logs", "Optional directory to store junit and pod logs output in. If not specified, no junit or logs files will be output")

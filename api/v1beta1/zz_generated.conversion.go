...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*BackupCondition)(nil), (*v1alpha1.BackupCondition)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_BackupCondition_To_v1alpha1_BackupCondition(a.(*BackupCondition), b.(*v1alpha1.BackupCondition), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*v1alpha1.BackupCondition)(nil), (*BackupCondition)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_BackupCondition_To_v1beta1_BackupCondition(a.(*v1alpha1.BackupCondition), b.(*BackupCondition), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta1_BackupCondition_To_v1alpha1_BackupCondition(in *BackupCondition, out *v1alpha1.BackupCondition, s conversion.Scope) error {
	out.Type = v1alpha1.BackupConditionType(in.Type)
...
// Convert_v1beta1_BackupCondition_To_v1alpha1_BackupCondition is an autogenerated conversion function.
func Convert_v1beta1_BackupCondition_To_v1alpha1_BackupCondition(in *BackupCondition, out *v1alpha1.BackupCondition, s conversion.Scope) error {
	return autoConvert_v1beta1_BackupCondition_To_v1alpha1_BackupCondition(in, out, s)
}

func autoConvert_v1alpha1_BackupCondition_To_v1beta1_BackupCondition(in *v1alpha1.BackupCondition, out *BackupCondition, s conversion.Scope) error {
	out.Type = BackupConditionType(in.Type)
	out.Status = v1.ConditionStatus(in.Status)
	out.LastTransitionTime = in.LastTransitionTime
	out.Reason = in.Reason
	out.Message = in.Message
...
// Convert_v1alpha1_BackupCondition_To_v1beta1_BackupCondition is an autogenerated conversion function.
func Convert_v1alpha1_BackupCondition_To_v1beta1_BackupCondition(in *v1alpha1.BackupCondition, out *BackupCondition, s conversion.Scope) error {
	return autoConvert_v1alpha1_BackupCondition_To_v1beta1_BackupCondition(in, out, s)
}
...
func autoConvert_v1beta1_BackupSpec_To_v1alpha1_BackupSpec(in *BackupSpec, out *v1alpha1.BackupSpec, s conversion.Scope) error {
	out.Image = in.Image
	// WARNING: in.HostFrom requires manual conversion: does not exist in peer-type
	out.NFSServerAddress = in.NFSServerAddress
	out.ClusterName = in.ClusterName
	out.HistoryLimit = (*int32)(unsafe.Pointer(in.HistoryLimit))
	return nil
}
...
func autoConvert_v1beta1_BackupStatus_To_v1alpha1_BackupStatus(in *BackupStatus, out *v1alpha1.BackupStatus, s conversion.Scope) error {
	...
	out.BackupDate = in.BackupDate
	out.BackupType = in.BackupType
	out.Conditions = *(*[]v1alpha1.BackupCondition)(unsafe.Pointer(&in.Conditions))
	return nil
}

// Convert_v1beta1_BackupStatus_To_v1alpha1_BackupStatus is an autogenerated conversion function.
func Convert_v1beta1_BackupStatus_To_v1alpha1_BackupStatus(in *BackupStatus, out *v1alpha1.BackupStatus, s conversion.Scope) error {
	return autoConvert_v1beta1_BackupStatus_To_v1alpha1_BackupStatus(in, out, s)
}
...
func autoConvert_v1alpha1_BackupStatus_To_v1beta1_BackupStatus(in *v1alpha1.BackupStatus, out *BackupStatus, s conversion.Scope) error {
	...
	out.BackupDate = in.BackupDate
	out.BackupType = in.BackupType
	out.Conditions = *(*[]BackupCondition)(unsafe.Pointer(&in.Conditions))
	return nil
}

// Convert_v1alpha1_BackupStatus_To_v1beta1_BackupStatus is an autogenerated conversion function.
func Convert_v1alpha1_BackupStatus_To_v1beta1_BackupStatus(in *v1alpha1.BackupStatus, out *BackupStatus, s conversion.Scope) error {
	return autoConvert_v1alpha1_BackupStatus_To_v1beta1_BackupStatus(in, out, s)
}

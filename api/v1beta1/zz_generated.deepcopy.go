...
func (in *BackupOps) DeepCopyInto(out *BackupOps) {
	*out = *in
	...
	if in.S3Binlog != nil {
		in, out := &in.S3Binlog, &out.S3Binlog
		*out = new(S3Binlog)
		**out = **in
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *S3Binlog) DeepCopyInto(out *S3Binlog) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new S3Binlog.
func (in *S3Binlog) DeepCopy() *S3Binlog {
	if in == nil {
		return nil
	}
	out := new(S3Binlog)
